...
enum SportsCategory: String, Hashable {
    ...
    init(sport: String?) {
        ...
        case "헬스", "헬스PT", "보디빌딩":
            self = .health
        case "GX", "TRX", "서킷트레이닝", "스피닝바이크", "에어로빅", "다이어트로빅", "시니어로빅", "태보", "점핑다이어트", "점핑트램폴린", "핏밸런스", "여성순환운동":
            self = .fitness
        case "요가", "파워요가", "필라테스", "SNPE":
            self = .yogaPilates
        case "국선도", "국학기공", "태극권", "생활체조", "체조", "스트레칭":
            self = .gymnastics
        case "댄스", "라인댄스", "방송댄스", "벨리댄스", "스포츠댄스", "줌바댄스", "다이어트댄스", "발레", "전통무용", "한국무용":
            self = .dance
        case "수영", "생존수영", "수중보건체조", "아쿠아로빅", "아쿠아워킹", "아쿠아슬론", "아티스틱 스위밍", "스킨스쿠버":
            self = .aquaticSports
        case "농구", "축구", "풋살", "야구", "배드민턴", "탁구", "테니스", "스쿼시", "라켓볼", "피클볼", "골프", "파크골프", "게이트볼", "당구", "볼링", "플로어볼":
            self = .ballSports
        case "스케이트", "스피드 스케이팅", "피겨", "스키":
            self = .iceSports
        case "검도", "복싱", "유도", "태권도", "택견", "펜싱", "국궁":
            self = .martialArts
        case "러닝", "달리기", "육상", "자전거", "런바이크", "철인 3종":
            self = .runningCycle
        case "생활체육", "아동체육", "유아체육", "줄넘기", "여성건강교실", "바디스킬릴리즈":
            self = .recreationalSports
        case "보치아":
            self = .adaptivePhysicalEducation
        default:
            self = .other
        }
    }
