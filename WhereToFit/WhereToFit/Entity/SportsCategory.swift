...
enum SportsCategory: String, CaseIterable, Hashable, Sendable {
    ...
    static let sportsByCategory: [SportsCategory: [String]] = [
        .health: ["헬스", "헬스PT", "보디빌딩"],
        .fitness: ["피트니스", "GX", "TRX", "서킷트레이닝", "스피닝바이크", "에어로빅", "다이어트로빅", "시니어로빅", "태보", "점핑다이어트", "점핑트램폴린", "핏밸런스"],
        .yogaPilates: ["요가", "파워요가", "필라테스", "SNPE"],
        .gymnastics: ["국선도", "국학기공", "생활체조", "체조", "스트레칭"],
        ...
        .martialArts: ["검도", "복싱", "유도", "태권도", "태극권", "택견", "펜싱", "국궁"],
        .runningCycle: ["러닝", "달리기", "육상", "자전거", "런바이크", "철인 3종"],
        .recreationalSports: ["생활체육", "아동체육", "유아체육", "줄넘기", "여성건강교실", "여성순환운동", "바디스킬릴리즈"],
